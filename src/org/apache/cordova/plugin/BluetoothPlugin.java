...
public class BluetoothPlugin extends Plugin {
	...
	public void setContext(CordovaInterface ctx) {
		...
		cordova.getActivity().getApplicationContext().registerReceiver(m_bpBroadcastReceiver, new IntentFilter(
				BluetoothAdapter.ACTION_DISCOVERY_FINISHED));
		cordova.getActivity().getApplicationContext().registerReceiver(m_bpBroadcastReceiver, new IntentFilter(
				BluetoothDevice.ACTION_FOUND));
		cordova.getActivity().getApplicationContext().registerReceiver(m_bpBroadcastReceiver, new IntentFilter(BluetoothPlugin.ACTION_UUID));
